report 52104 "HMP Check (Stub/Check/Stub)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/HMPCheckStubCheckStub.rdl';
    Caption = 'HMP Check (Stub/Check/Stub)';
    ...
    var
        ...
        USText017: Label 'Invoice/Document';
        StartingLen: Integer;
        ControlLen: Integer;
        NewLen: Integer;
        ...
        Posting_DescriptionCaptionLbl: Label 'Invoice/Document';
    ...
    begin
        ...
        PostingDesc := VendLedgEntry2."Document No.";
