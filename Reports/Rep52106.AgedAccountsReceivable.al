report 52106 "HMP Aged Accounts Receivable"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/HMPAgedAccountsReceivable.rdl';
    ApplicationArea = all;
    Caption = 'HMP Aged Accounts Receivable';
        ...
        dataitem(Header; "Integer")
        {
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem(Totals; "Integer")
                {
                    ...
                    column(Cust__Ledger_Entry_CustomerPONumber; "Cust. Ledger Entry"."External Document No.")
                    { }
                    column(Cust__Ledger_Entry_Amount; abs("Cust. Ledger Entry".Amount))
                    { }
                    ...
                    begin
                        ...
                        TempCustLedgEntry.CalcFields("Remaining Amount", "Remaining Amt. (LCY)", Amount);
                ...
                begin
                    ...
                    if PaymentTermsRecGbl.get(Customer."Payment Terms Code") then;
                end;
    ...
    var
        ...
        CustomerPOLbl: Label 'Customer PO Number';
    ...
    begin
        ...
        ExcelBuf.AddColumn(CustomerPOLbl, false, '', true, false, true, '', ExcelBuf."Cell Type"::Text);
    ...
    begin
        ...
        ExcelBuf.AddColumn("Cust. Ledger Entry"."External Document No.", false, '', false, false, false, '', ExcelBuf."Cell Type"::date);
        if PrintDetail then begin
