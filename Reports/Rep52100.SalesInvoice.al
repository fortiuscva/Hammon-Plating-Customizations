report 52100 "HMP Sales Invoice"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(Shipment_Details_Caption; Shipment_Details_CaptionLbl)
            { }
            column(Ship_Date_Caption; Ship_Date_CaptionLbl)
            { }
            column(Carrier_Catpion; Carrier_CatpionLbl)
            { }
            column(Tracking_Caption; Tracking_CaptionLbl)
            { }
            column(Freight_Caption; Freight_CaptionLbl)
            { }
            column(Misc_Charge_Caption; Misc_Charge_CaptionLbl)
            { }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(SalesInvLine; "Integer")
                    {
                        ...
                        column(CarrierValue; 0)
                        { }
                        column(TrackingValue; "Sales Invoice Header"."Package Tracking No.")
                        { }
                        column(FreightValue; 0)
                        { }
                        column(Misc_ChargeValue; 0)
                        { }
                        column(SalesTaxValue; 0)
                        { }
                        column(PreAllocatedCreditValue; 0)
                        { }
                        column(HighestLineNo; HighestLineNo)
                        { }
                        column(TempSalesInvoiceLine_Desc; DescriptionToPrint)
                        { }
    ...
    var
        ...
        Shipment_Details_CaptionLbl: label 'SHIPMENT DETAILS';
        Ship_Date_CaptionLbl: Label 'SHIP DATE';
        Carrier_CatpionLbl: Label 'CARRIER';
        Tracking_CaptionLbl: Label 'TRACKING #';
        Freight_CaptionLbl: Label 'FREIGHT';
        Misc_Charge_CaptionLbl: Label 'MISC CHARGE';
        SalesTax_CaptionLbl: Label 'SALES TAX';
        Pre_allocated_CreditLbl: Label 'PRE-ALLOCATED CREDIT';
        [InDataSet]
        LogInteractionEnable: Boolean;
        DisplayAssemblyInformation: Boolean;
        BillCaptionLbl: Label 'BILL TO';
        ToCaptionLbl: Label 'To:';
        ShipViaCaptionLbl: Label 'DISCOUNT DATE';
        ShipDateCaptionLbl: Label 'ORDER DATE';
        DueDateCaptionLbl: Label 'DUE DATE';
        TermsCaptionLbl: Label 'TERMS';
        CustomerIDCaptionLbl: Label 'CUSTOMER #';
        PONumberCaptionLbl: Label 'P.O. #';
        PODateCaptionLbl: Label 'INCOTERM';
        OurOrderNoCaptionLbl: Label 'ORDER #';
        SalesPersonCaptionLbl: Label 'SHIPMENT #';
        ShipCaptionLbl: Label 'SHIP TO';
        InvoiceNumberCaptionLbl: Label 'INVOICE #';
