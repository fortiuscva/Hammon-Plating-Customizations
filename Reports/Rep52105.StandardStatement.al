report 52105 "HMP Standard Statement"
{
    RDLCLayout = './Reports/HMPStandardStatement.rdl';
    Caption = 'HMP Customer Statement';
    DefaultLayout = RDLC;
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            column(PostDate_DtldCustLedgEntries; Format(DocumentDateVarGbl))
                            {
                            }
                            ...
                            Column(AppliedAmount; AppliedAmountVarGbl)
                            {
                            ...
                            begin
                                ...
                                PrintLine := true;
                                YourReference := '';
                                clear(DocumentDateVarGbl);
                                clear(AppliedAmountVarGbl);
                                case "Entry Type" of
                                    "Entry Type"::"Initial Entry":
                                        begin
                                            ...
                                            DocumentDateVarGbl := CustLedgerEntry."Document Date";
                                            AppliedAmountVarGbl := CustLedgerEntry."Original Amount" - CustLedgerEntry."Remaining Amount";
                    ...
                    dataitem(OverdueVisible; "Integer")
                    {
                        ...
                        dataitem(CustLedgEntry2; "Cust. Ledger Entry")
                        {
                            ...
                            Column(AppliedAmount_CustLedgEntry2; AppliedAmountCustLedgerVarGbl)
                            {
                            ...
                            begin
                                clear(AppliedAmountCustLedgerVarGbl);
                                ...
                                AppliedAmountCustLedgerVarGbl := CustLedgEntry."Original Amount" - CustLedgEntry."Remaining Amount";
    ...
    var
        ...
        SalesInvoiceHeaderRecGbl: Record "Sales Invoice Header";
        ...
        PostDate_DtldCustLedgEntriesCaptionLbl: Label 'Document Date';
        DueDate_CustLedgEntry2CaptionLbl: Label 'Due Date';
        CustBalanceCaptionLbl: Label 'Running Total';
        beforeCaptionLbl: Label 'over 90 and Total Due';
    ...
    protected var
        ...
        AppliedAmountVarGbl: Decimal;
        AppliedAmountCustLedgerVarGbl: Decimal;
